...
router.post('/', async (req, res) => {
  try {
    ...
    res.status(201).json({ success: true, data: appointment, message: 'Agendamento criado com sucesso' })
  } catch (error) {
...
router.put('/:id', async (req, res) => {
  try {
    ...
    res.json({ success: true, data: appointment, message: 'Agendamento atualizado com sucesso' })
  } catch (error) {
